...
body {background:url('fail.png') center no-repeat #262626}
...
<body>
<div class="content">
Возникла ошибка при оплате, попробуйте повторить операцию снова!</br>
Через 5 секунд вы будете перенаправлены в <a href="../index.php">личный кабинет</a>
<?php
